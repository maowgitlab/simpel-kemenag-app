...
class ReportController extends Controller
{
    ...
    {
        $pdf = Pdf::loadView('cms.pages.report.output.all-media', [
    ...
    public function mediaByCategoryOutput(Request $request)
    {
        if ($request->has('categoryID')) {
            ...
            $pdf = Pdf::loadView('cms.pages.report.output.media-by-category', [
                'medias' => $this->media->with('user', 'category', 'tags')
    ...
    public function mediaByTimeOutput(Request $request)
    {
        if ($request->has('start') && $request->has('end')) {
            ...
            $pdf = Pdf::loadView('cms.pages.report.output.media-by-time', [
    ...
    {
        $pdf = Pdf::loadView('cms.pages.report.output.popular-media', [
    ...
    {
        $pdf = Pdf::loadView('cms.pages.report.output.most-media-category', [
    ...
    {
        $pdf = Pdf::loadView('cms.pages.report.output.service-in', [
    ...
    {
        $pdf = Pdf::loadView('cms.pages.report.output.service-category', [
    ...
    {
        $pdf = Pdf::loadView('cms.pages.report.output.service-status', [
