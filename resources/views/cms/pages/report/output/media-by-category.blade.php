...
<head>
  ...
  <title>Laporan Media Berdasarkan Kategori</title>
</head>

<body>
  <table width="100%">
    <tr>
      <td><img src="{{ public_path('kemenag_logo.png') }}" width="100px" height="100px"></td>
      <td>
        <center>
  ...
  <h2 style="text-align: center">Laporan Media Berdasarkan Kategori</h2>
