...
@section('title', 'Laporan Semua Media')
@section('cms')
  @if (session()->has('message'))
    {!! session('message') !!}
  @endif
  <div class="pagetitle">
    <h1>Laporan Semua Media</h1>
    <nav>
      <ol class="breadcrumb">
        <li class="breadcrumb-item"><a href="{{ route('dashboard') }}">Dashboard</a></li>
        <li class="breadcrumb-item active">Laporan Semua Media</li>
      </ol>
    </nav>
  </div><!-- End Page Title -->
    ...
    <div class="row">
      <div class="col-md-12">
        <div class="card">
          <div class="card-body">
            @if (!$medias->isEmpty())
              <a href="{{ route('allPostOutput') }}" class="shadow-sm btn btn-sm btn-danger mt-3"><i
                ...
                <tbody>
                  ...
                  @empty
                    <div class="alert alert-secondary">
                      <i class="bi bi-info-circle"></i> Media belum tersedia.
                    </div>
                  @endforelse
                </tbody>
              </table>
