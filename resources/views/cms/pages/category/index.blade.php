...
@section('cms')
  ...
  <section class="section">
    <div class="row">
      <div class="col-md-12">
        <a href="{{ route('createCategory') }}" class="shadow-sm btn btn-sm btn-primary mb-3"><i
            class="bi bi-plus-circle"></i> Input Kategori Baru</a>
        <div class="card">
          <div class="card-body">
                    ...
                    <tr>
                      ...
                      <td class="align-middle text-center">
                        <div class="btn-group" role="group" aria-label="Basic mixed styles example">
                          ...
                          @endif
                          <a href="{{ route('editCategory', $category->id) }}" class="btn btn-sm btn-warning"><i
