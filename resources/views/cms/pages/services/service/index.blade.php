...
@section('cms')
  ...
  <section class="section">
    <div class="row">
      <div class="col-md-12">
        <a href="{{ route('createService') }}" class="shadow-sm btn btn-sm btn-primary mb-3"><i
                  ...
                  @foreach ($services as $service)
                    <tr>
                      ...
                      <td class="align-middle">
                        ...
                        <a href="{{ asset('storage/' . $service->file_sop) }}" target="_blank" class="btn btn-sm btn-info"><i class="bi bi-eye"></i></a>
                        @else
                        -
                        @endif
                      </td>
                      <td class="align-middle">
                        ...
                        <a href="{{ asset('storage/' . $service->file_permohonan) }}" target="_blank" class="btn btn-sm btn-info"><i class="bi bi-eye"></i></a>
                        @else
                        -
                        @endif
                      </td>
                      <td class="align-middle text-center">
                        <div class="btn-group" role="group">
                          ...
                          <a href="{{ route('editService', $service->id) }}" class="btn btn-sm btn-warning"><i
