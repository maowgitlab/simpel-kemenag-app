...
@section('cms')
  ...
  <section class="section">
    <div class="row">
      <div class="col-md-12">
        <a href="{{ route('createTag') }}" class="shadow-sm btn btn-sm btn-primary mb-3"><i class="bi bi-plus-circle"></i>
          Input Tag Baru</a>
        <div class="card">
          <div class="card-body">
                  ...
                  @foreach ($tags as $tag)
                    <tr>
                      ...
                      <td class="align-middle text-center"><small class="fw-bold text-muted"><i class="bi bi-eye"></i>
                          {{ $tag->jumlah_dibaca }} Kali</small></td>
                      <td class="align-middle text-center">
                        @if (auth()->user()->role == 'admin')
                          <div class="btn-group" role="group" aria-label="Basic mixed styles example">
                            ...
                            <a href="{{ route('editTag', $tag->id) }}" class="btn btn-sm btn-warning"><i
