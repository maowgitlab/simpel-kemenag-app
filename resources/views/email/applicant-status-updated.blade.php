...
<body>
    <div class="container">
        ...
        <div class="content">
            ...
            <p>Status permohonan Anda dengan kode layanan <strong>{{ $applicant->kode_layanan }}</strong> telah diperbarui menjadi <strong>{{ $applicant->status }}</strong>.</p>
            ...
            <ul>
                ...
                <li><strong>Pesan Pemohon:</strong> {{ $applicant->pesan }}</li>
                <li><strong>Diproses Oleh:</strong> {{ $applicant->diproses_oleh }}</li>
                <li><strong>File Persyaratan:</strong> <a href="{{ $applicant->file_persyaratan == null ? '#' : asset($applicant->file_persyaratan) }}">{{ $applicant->file_persyaratan == null ? '-' : 'Lihat' }}</a></li>
